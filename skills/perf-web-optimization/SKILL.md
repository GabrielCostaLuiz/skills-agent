...
For running audits, reading reports, and setting budgets, see **[Lighthouse Audits](../perf-lighthouse/SKILL.md)**.
...
- [Lighthouse Audits](../perf-lighthouse/SKILL.md) - Measure and monitor performance.
- [Astro Performance](../perf-astro/SKILL.md) - Framework specific optimizations.
